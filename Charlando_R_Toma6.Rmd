...
Vamos a importar el dataset  terremotos.cvs pero antes lo miramos para ver los decimales y las columnas.

Si las columnas estan separadas con **,**  y los decimales con **.**  usamos `read_csv`
